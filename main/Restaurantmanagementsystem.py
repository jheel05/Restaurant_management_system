...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By jheel soni",bd=2,relief=SUNKEN)
...
lblLargefries = Label(f1, font=( 'aria' ,16, 'bold' ),text="Royal Indian thali",fg="steel blue",bd=10,anchor='w')
...
def price():
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Royal Indian thali", fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="540", fg="steel blue", anchor=W)
